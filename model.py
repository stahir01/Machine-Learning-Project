...
class NewUNet(nn.Module):
    def __init__(self) -> None:
        ...
        self.middle_conv_1 = nn.Conv2d(in_channels=512, out_channels=1024, kernel_size=3)
        self.middle_conv_2 = nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=3)
